...
<div class = "container">
<button class="btn btn-outline-secondary" type="submit" name="Movie_list" id="Movie_list">All Movies</button>
<button class="btn btn-outline-secondary" type="submit" name="Actors_list" id="Actors_list">All Actors</button>
</div>
<div class = "container">
...
<div class="container">
    ...
    elseif(isset($_POST['Movie_list'])){
        ...
        // initialize table headers
        // YOU WILL NEED TO CHANGE THIS DEPENDING ON TABLE YOU QUERY OR THE COLUMNS YOU RETURN
        echo "<tr><th class='col-md-2'>Movie Namr</th><th class='col-md-2'>Production</th></tr></thead>";


        try {
            // prepare statement for executions. This part needs to change for every query
            // query to 
            $stmt = $conn->prepare("SELECT name,production FROM Movie");
